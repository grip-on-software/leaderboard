...
class builder {
    constructor(locales, data, normalize, localization, links, groups) {
        this.data = data;
    ...
    setSortOrder(order) {
        ...
        let items = _.sortBy(data, (d) => {
            ...
            if (order === 'feature') {
                return this.locales.retrieve(this.localization, d.key);
            }
            if (order === 'group') {
    ...
    addCards(items) {
        ...
        cardHeader.append('a')
            ...
            .attr('title', d => this.currentProject === null ?
        ...
        cardHeader.append('a')
            ...
            .attr('target', '_blank')
            .attr('title', this.locales.message("source-link"))
            .classed('is-hidden', d => {
