...
class Builder {
    ...
    addCards(items) {
        ...
        cardHeader.append('a')
            ...
            .attr('data-tooltip', d => this.currentProject === null ?
                ...
                this.locales.message("card-swap-feature",
                    [this.locales.retrieve(this.localization, d.feature)]
                )
            )
            .attr('aria-label', d => this.currentProject === null ?
                this.locales.message("card-swap-project", [d.project]) :
                this.locales.message("card-swap-feature",
                    [this.locales.retrieve(this.localization, d.feature)]
                )
        ...
        cardHeader.append('a')
            ...
            .attr('target', '_blank')
            .attr('data-tooltip', d => this.locales.message("source-link",
                [this.locales.retrieve(this.localization, d.feature)]
            ))
            .attr('aria-label',  d => this.locales.message("source-link",
                [this.locales.retrieve(this.localization, d.feature)]
            ))
            .classed('is-hidden', d => {
