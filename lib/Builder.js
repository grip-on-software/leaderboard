/**
 * Leaderboard data-driven builder.
 *
...
class Builder {
    ...
    addCards(items) {
        ...
        title.append('span')
            ...
            .attr('title', d => this.currentProject === null ? null : d.getFeatureTitle())
        ...
        const cardContent = card.append('div')
            ...
            .append('div')
            .classed('columns is-multiline is-mobile', true);
        ...
        cardContent.append('div')
            ...
            .on("click", (ev, d) => { location.hash = `#${this.group.getLeadProject(d.feature)}`; })
    ...
    createCards(old='project') {
        ...
        d3.selectAll('label.hide-project, label.hide-project input')
            .attr('disabled', this.currentProject !== null ? true : null);
        d3.selectAll('label.hide-feature, label.hide-feature input')
            .attr('disabled', this.currentFeature !== null ? true : null);
        d3.select('#cards').html('');
        this.addCards(items);
    }
