...
class CardGroup {
    constructor(project, feature, locale, mode, data, items) {
    ...
    getFeatureValues(feature) {
        let values = _.mapValues(this.data,
    ...
    getTotalScore() {
        ...
        let value = this.roundValue(totalScore, totalFeatures);
...
class CardLocale {
    ...
    getFeatureName(feature) {
        return this.locales.retrieve(this.localization, feature);
    }
...
class Card {
    ...
    getCardTitle() {
        ...
        return `<span class="card-title">${name}</span>
            ...
            <span class="card-normalize">${this.locale.getFeatureName(normalize)}</span>`;
    }
