...
class Box {
    ...
    buildBox(g, d, i, highlight) {
        ...
        d.quartiles = this.options.quartiles(d);
        ...
        this.update(g, d, {
            highlight,
            quartile: d.quartiles,
            whisker: whiskerData,
            outlier: outlierIndices
        });
    }
